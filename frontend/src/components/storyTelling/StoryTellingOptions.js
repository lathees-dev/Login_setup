...
const StoryTellingOptions = () => {
  const navigate = useNavigate();

  const options = [
    {
      title: 'Learn',
      description: 'Learn the fundamentals of storytelling',
      icon: <SchoolIcon sx={{ fontSize: '4rem' }} />,
      path: '/story-telling/learn'
    },
    {
      title: 'Practice',
      description: 'Practice your storytelling skills',
      icon: <SportsEsportsIcon sx={{ fontSize: '4rem' }} />,
      path: '/story-telling/practice'
    },
    {
      title: 'Test',
      description: 'Test your storytelling abilities',
...
export default StoryTellingOptions; 